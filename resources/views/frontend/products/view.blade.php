    ...
    <div class="py-3 mb-4 shadow-sm bg-warning border-top">
        <div class="container">
            <h6 class="mb-0">
                ...
                <a href="{{ url('category/' . $product->category->slug) }}"></a>
                <a href="{{ url('category/' . $product->category->slug . '/' . $product->slug) }}"></a>
        </div>
    </div>
            ...
            <div class="">
                <div class="row">
                    <div class="col-md-4 border-right ">
                        <a href="{{ asset('assets/uploads/product/' . $product->image) }}" data-lightbox="photos"><img
                                src="{{ asset('assets/uploads/product/' . $product->image) }}" class="w-100"
                                alt=""></a>
                    </div>
                    <div class="col-md-8">
                        <h2 class="mb-0">
                            ...
                            <div class="container">
                                ...
                                <div class="photos">
                                    @foreach ($images as $image)
                                        {{-- <div class="row item"> --}}
                                        <a href="{{ asset('assets/uploads/product/' . $image['image']) }}"
                                            data-lightbox="photos"><img class="img-fluid"
                                                src="{{ asset('assets/uploads/product/' . $image['image']) }}"></a>
                                        {{-- </div> --}}
                                    @endforeach
                                </div>
                            </div>
                            ...
                            @foreach ($reviews as $item)
                                <div class="user-review">
                                    ...
                                    @if ($rating)
                                        ...
                                        @endfor
                                    @endif
                                    <small>Review on 27 {{ $item->created_at->format('d M Y') }}</small>
                                    <p>
                                        {{ $item->user_review }}
                                    </p>
                                </div>
